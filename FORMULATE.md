...
Now, you will carefully consider the evaluation results and the retrospective findings, and you will formulate a plan to make changes to the codebase to correctly and comprehensively address the comments that are to be accepted (including any retro violations surfaced in the evaluation) and to ignore the comments that are to be rejected.
