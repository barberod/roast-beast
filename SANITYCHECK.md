...
You have recently performed a sequence of 5 tasks.
...
Fifth, you implemented your plan by making changes to the codebase (IMPLEMENT). You might or might not have reconsidered your plan while you were working on the code.

### Now what?

Consider the pseudo-comments. Consider the retro findings. Consider the evaluation results. Consider the plan. Consider the recent changes to the codebase (which are probably still unstaged).
...
If you cannot confidently answer "No" to each of the questions above, return to the "Implement" step and continue to work on the codebase. Communicate with the user.
...
Proceed to generating the desired output.
